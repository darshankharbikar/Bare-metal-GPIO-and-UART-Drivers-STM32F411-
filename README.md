# Bare-metal-GPIO-and-UART-Drivers-STM32F411-
Wrote low-level drivers without SDK support using TRM references and register maps. Created interrupt-safe logging system with circular buffer.
